...
public class HookLoader implements IHookLoader {
	...
	public void load(IHookRegistry registry) {
		registry.insertBeforeMethod("net.minecraft.block.Block", "func_176203_a", "(I)Lnet/minecraft/block/state/IBlockState;", "org.agecraft.hookinator.test.TestHooks", "getStateFromMeta");
	}
}
